            ...
            <Grid>
              <Col style={{alignItems: 'center'}}>
                <Icon
                  ...
                  onPress={() =>
                    Linking.openURL(
                      'https://www.facebook.com/Rashid-ki-Dukan-111408897704353',
              ...
              <Col style={{alignItems: 'center'}}>
                <Icon
                  ...
                  onPress={() =>
                    Linking.openURL(
                      'https://www.instagram.com/rashid_ch00/',
                    ).catch(err => console.error('An error occurred', err))
                  }
                />
              </Col>
              ...
              <Col style={{alignItems: 'center'}}>
                <Icon
                  ...
                  onPress={() =>
                    Linking.openURL(
                      'https://www.youtube.com/channel/UC-EwfaoO1rrRTBj1NK241Sw',
                    ).catch(err => console.error('An error occurred', err))
                  }
                />
              </Col>
              <Col style={{alignItems: 'center'}}>
                <Icon
                  ...
                  name="logo-whatsapp"
                  onPress={() =>
                    Linking.openURL('http://www.whatsapp.com/').catch(err =>
                      console.error('An error occurred', err),
                    )
                  }
                />
