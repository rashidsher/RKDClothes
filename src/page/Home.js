  ...
  render() {
    ...
    return(
      <SideMenuDrawer ref={(ref) => this._sideMenuDrawer = ref}>
          <Container>
            <Navbar left={left} right={right} title="Rashid KD" />
            <Content>
...
var categories = [
  ...
  },
  {
    ...
    title: 'KIDS',
    image:
      'https://cherryberrystores.com/image/cache/catalog/slideshow/web-11-4-2021-860x360.jpeg',
  },
  {
    id: 4,
    title: 'Bed Sheets',
    image:
      'https://5.imimg.com/data5/NS/RD/UO/SELLER-46233486/mandala-print-cotton-bed-sheet-500x500.jpg',
  },
